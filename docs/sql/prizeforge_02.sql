...
CREATE database if NOT EXISTS `prizeforge_02` default character set utf8mb4;
use `prizeforge_02`;
...
CREATE TABLE `raffle_activity_account` (
  ...
  `current_order_id` varchar(32) NOT NULL DEFAULT '' COMMENT '当前已扣额度但尚未完成的抽奖订单',
...
CREATE TABLE `user_award_record_000` (
  ...
  `order_id` varchar(32) NOT NULL COMMENT '抽奖订单ID【作为幂等使用】',
