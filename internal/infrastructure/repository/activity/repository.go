...
func NewRepository(routerDB *adapter.DBRouter, db *gorm.DB, redis *cache.Cache, stockZeroPublisher *adapter.Publisher, queue *asynq.Client, inspector *asynq.Inspector) activitybiz.Repo {
	return &Repository{
		routerDB:           routerDB,
		db:                 db,
		redis:              redis,
