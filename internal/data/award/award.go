...
import (
	awardbiz "big-market-kratos/internal/biz/award"
...
func NewUserAwardRecordRepository(db *infra.DBRouter, redis *cache.Cache, publisher *infra.Publisher) awardbiz.Repo {
...
func (r *UserAwardRecord) SaveUserAwardRecord(ctx context.Context, aggregate *awardbiz.UserAwardTaskInfo) error {
	...
	pendingOrderKey := infra.GetPendingRaffleOrderKey(aggregate.UserAwardRecord.ActivityID, aggregate.UserAwardRecord.UserID)
